...
export type getOrdersStatisticsByIdRes = BASE_RESPONSE<getOrdersStatisticsByIdData>;
...
export type GetTotalRemainingBalanceRes = BASE_RESPONSE<number>;

export type GetProductsCountByTenantRes = BASE_RESPONSE<GetProductCountByTenantData>;
...
export type GetLastFiveOrdersRes = BASE_RESPONSE<GetLastFiveOrdersData>;
